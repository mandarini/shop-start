...
/**
 *
 * This code is supposed to send a push notification to a user
 * who clicks on the button to accept push notifications.
 *
 * It is triggered each time the document("fcmTokens/{tokenId}") is written.
 *
 * Find what is wrong with this code and fix it.
 *
 * (tip: it might be sending push notifications to everyone)
 *
 */
